    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.Box1}>
        <View style={styles.My_view}>
          ...
          <TextInput style={styles.Text_input} placeholder={'  ' + '이름'} />
        </View>
        ...
        <View style={styles.My_view}>
          ...
          <TextInput style={styles.Text_input} placeholder={'  ' + 'ID'} />
        </View>
        ...
        <View style={styles.My_view}>
          ...
          <TextInput style={styles.Text_input} placeholder={'  ' + '주소'} />
        </View>
        ...
        <View style={styles.My_view}>
          ...
          <TextInput style={styles.Text_input} placeholder={'  ' + 'Phone'} />
        </View>
      </View>
      ...
      <View style={styles.Edit}>
        <Pressable
          onPress={() => {
            navigation.reset({ routes: [{ name: 'MyInfo_Screen' }] });
          }}
